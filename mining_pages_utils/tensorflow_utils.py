...
def run_inference_for_series(series: pd.Series, tensor_dict, session) -> pd.Series:
...
def run_inference_for_figureseries(series: pd.Series, tensor_dict, session) -> pd.Series:
